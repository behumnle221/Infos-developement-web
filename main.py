# ================================================
# main.py  →  Blog API SQLite (VERSION FINALE OK)
# ================================================
...
def favicon():
    ...
    return {"message": "No favicon found"}  # évite erreur si fichier absent
